...
export class  PasswordCheckService {
    ...
    public  checkPasswordMayusculas(password: string):Boolean {
    ...
    public  checkPasswordNumeros(password: string):Boolean {
    ...
    public  checkPasswordEspecialCaracteres(password: string):Boolean {
