...
const store = {
  ...
  skin: config.skins.find((_skin: { name: any; }) => {
...
export class LayoutService {
  ...
  subscribe(next: any = null, err: any = null, complete: any = null) {
  ...
  processBody(state: { skins: any[]; skin: { name: JQuery.TypeOrArray<string> | ((this: HTMLElement, index: number, currentClassName: string) => string); logo: string | number | ((this: HTMLElement, index: number, attr: string) => string | number | void | undefined) | null; }; fixedHeader: any; fixedNavigation: any; fixedRibbon: any; fixedPageFooter: any; insideContainer: any; rtl: any; menuOnTop: any; colorblindFriendly: any; shortcutOpen: any; mobileViewActivated: boolean; isMobile: any; menuCollapsed: any; menuMinified: any; }) {
    let $body = $('body');
